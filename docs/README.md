...
- **Implementation**: Runs in `terraform-validate` GitHub Actions workflow (`.github/workflows/terraform-validate.yaml`) via script `.github/scripts/infra/scan-terraform-security-checkov.sh`
...
- **Files**: `.github/workflows/terraform-validate.yaml`, `.github/scripts/infra/scan-terraform-security-checkov.sh`
...
- **Implementation**: Images signed with Cosign keyless signing in CI/CD (`.github/scripts/applications/sign-and-verify-container-image.sh`); Kyverno policy `require-cosign-signature` verifies signatures at admission time
...
- **Files**: `.github/scripts/applications/sign-and-verify-container-image.sh`, `kyverno/policies/cluster/require-cosign-signature.yaml`, `.github/workflows/applications-microservice-Ci.yaml`
...
- **Implementation**: Trivy generates CycloneDX SBOMs in CI/CD (`.github/scripts/applications/generate-image-security-sbom.sh`); SBOMs uploaded to S3 for auditability
...
- **Files**: `.github/scripts/applications/generate-image-security-sbom.sh`, `.github/workflows/applications-microservice-Ci.yaml`
...
- **Implementation**: Filesystem scan (`.github/scripts/applications/scan-filesystem-vulnerabilities.sh`) runs before image build; image scan (`.github/scripts/applications/generate-image-security-sbom.sh`) runs after image push to ECR
...
- **Files**: `.github/scripts/applications/scan-filesystem-vulnerabilities.sh`, `.github/scripts/applications/generate-image-security-sbom.sh`, `.github/workflows/applications-microservice-Ci.yaml`
