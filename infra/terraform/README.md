...
**Key entry points**: `terraform/environments/{dev,stag,prod}/main.tf`
...
- **Backend configuration**: Defined in `terraform/environments/*/backend.tf`
...
1. Copy `terraform/environments/dev/` to `terraform/environments/<new-env>/`
...
- **VPC changes**: Edit `terraform/modules/vpc/main.tf`
- **EKS configuration**: Edit `terraform/modules/eks/main.tf` and `variables.tf`
- **IAM policies**: Edit `terraform/modules/iam/*/main.tf`
