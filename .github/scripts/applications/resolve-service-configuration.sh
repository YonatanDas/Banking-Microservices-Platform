...
# Usage: .github/scripts/applications/resolve-service-configuration.sh <service_name> <config_key>
# Example: .github/scripts/applications/resolve-service-configuration.sh accounts path
